...
import { useSpeechIntensityProcessor } from './voiceSpeechIntensityProcessor';
import { useVoiceInteractionOperations } from './voiceInteractionOperations';
...
export const useVoiceInteraction = (options: UseVoiceInteractionOptions = {}) => {
  ...
  // Use speech intensity processor
  const { handleSpeechIntensity } = useSpeechIntensityProcessor({
    setSpeechIntensity,
    setMouthTarget,
    resetMouth
  });
  ...
  // Use voice interaction operations
  const {
